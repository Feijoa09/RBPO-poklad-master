...
public class LicenseHistoryController {
     ...
     *
     * @param id            идентификатор записи истории лицензии
     * @param licenseId     идентификатор лицензии
     * @param userId        идентификатор пользователя
     * @param status        новый статус лицензии
     * @param description   новое описание изменения
     * @param changeDateStr новая дата изменения в формате 'yyyy-MM-dd'
    ...
    public ResponseEntity<?> update(@RequestParam Long id,                     // Идентификатор записи истории
        ...
        try {
            ...
            Date changeDate = dateFormat.parse(changeDateStr);
