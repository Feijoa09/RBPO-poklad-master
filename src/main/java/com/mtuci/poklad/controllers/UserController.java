...
public class UserController {
     ...
     */
    @PostMapping
    public ResponseEntity<?> save(@RequestParam DataUserRequest request) {
        try {
     ...
     *
     * @param request новые данные для обновления пользователя
     * @return ответ с обновленными данными пользователя
     */
    @PutMapping
    public ResponseEntity<?> update(@RequestParam DataUserRequest request) {
        try {
