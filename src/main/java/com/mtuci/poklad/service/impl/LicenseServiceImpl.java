...
public class LicenseServiceImpl implements LicenseService {
    ...
    public License createLicense(Long productId, Long ownerId, Long licenseTypeId, Integer deviceCount,
                                 ...
                                 boolean blocked, String code, String description) {
    ...
    private License edit(License license, DataLicenseRequest request) {
        ...
        license.setFirstActivationDate(request.getFirst_activation_date());
        license.setEndingDate(request.getEnding_date());
        license.setBlocked(request.isBlocked());
        license.setDeviceCount(request.getDevice_count());
